...
experiment_presets = {
    "A1": {"embed_dim": 256, "hidden_dim": 512, "num_layers": 4, "dropout": 0.3, "batch_size": 32, "lr": 0.001,
           "teacher_forcing_ratio": 0.5, "n_epochs": 20, "use_attention": True},

    "A2": {"embed_dim": 512, "hidden_dim": 512, "num_layers": 4, "dropout": 0.3, "batch_size": 32, "lr": 0.001,
           "teacher_forcing_ratio": 0.5, "n_epochs": 20, "use_attention": True},

    "A3": {"embed_dim": 512, "hidden_dim": 512, "num_layers": 4, "dropout": 0.5, "batch_size": 32, "lr": 0.001,
           "teacher_forcing_ratio": 0.5, "n_epochs": 20, "use_attention": True},

    "A4": {"embed_dim": 512, "hidden_dim": 512, "num_layers": 4, "dropout": 0.3, "batch_size": 128, "lr": 0.001,
           "teacher_forcing_ratio": 0.5, "n_epochs": 20, "use_attention": True},

    "A5": {"embed_dim": 512, "hidden_dim": 512, "num_layers": 4, "dropout": 0.3, "batch_size": 64, "lr": 0.001,
           "teacher_forcing_ratio": 0.5, "n_epochs": 20, "use_attention": True},
}
